  ...
  <div class="row">
    ...
    <th>Precio</th>
		...
		<?php foreach ($stmt as $row ){//extract($row);	?><!---->
				<tr>
					<td><?php echo $row->db_id;// $row['db_id'] ?></td>
					<td><?php echo  $row->db_nombre//$db_nombre; ?></td>
          <td>s/.<?php echo  $row->db_precio//$db_precio;?></td>
						<td><img src="imagenes/<?php echo $row->db_imagen// $row['db_imagen']; ?>" class="img-fluid" width="200px"/></td>
							<td>
							 	<a href="editar.php?edit_id=<?php echo $row->db_id; // $row['db_id']; ?>"  class="btn btn-warning"><img src="icons\pencil.svg" width="30px" alt="" class="img-fluid" ></a>
								<a href="crud.php?delete_id=<?php echo $row->db_id; //$row['db_id']; ?>" id="btn_alert__delete_" class="btn btn-danger"><img src="icons\trash.svg" width="30px" alt="" class="img-fluid"> </a>
                 ...
                 <a href="delete.php?delete_id=<?php echo  $row->db_id; //$row['db_id']; ?>" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modelDelete"  data-bs-backdrop="static" data-bs-keyboard="false" >d</a>
                 <a href="delete.php?delete_id=<?php echo $row->db_id; //$row['db_id']; ?>">dfdf</a>
